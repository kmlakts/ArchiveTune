...
package com.kmlakts.echomuse.cast
...
private class GmsCastMediaItemConverter(
    ...
    private fun MediaInfo?.toAppMediaMetadata(mediaId: String): com.kmlakts.echomuse.models.MediaMetadata {
        val castMetadata = this?.metadata
        val title = castMetadata?.stringValue(CastMetadata.KEY_TITLE) ?: mediaId
        val artistText =
        ...
        return com.kmlakts.echomuse.models.MediaMetadata(
            ...
            album =
                albumTitle?.let {
                    com.kmlakts.echomuse.models.MediaMetadata.Album(
                        id = it,
                        title = it,
                    )
                },
