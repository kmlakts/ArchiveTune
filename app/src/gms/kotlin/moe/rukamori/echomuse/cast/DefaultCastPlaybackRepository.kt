...
package moe.rukamori.echomuse.cast
...
private class GmsCastMediaItemConverter(
    ...
    private fun MediaInfo?.toAppMediaMetadata(mediaId: String): moe.rukamori.echomuse.models.MediaMetadata {
        val castMetadata = this?.metadata
        val title = castMetadata?.stringValue(CastMetadata.KEY_TITLE) ?: mediaId
        val artistText =
        ...
        return moe.rukamori.echomuse.models.MediaMetadata(
            ...
            album =
                albumTitle?.let {
                    moe.rukamori.echomuse.models.MediaMetadata.Album(
                        id = it,
                        title = it,
                    )
                },
    ...
    private fun openResolvedRemoteSource(
        ...
        val connection =
            (URL(resolvedUri.toString()).openConnection() as HttpURLConnection).apply {
                ...
                setRequestProperty("User-Agent", "Echomuse Cast")
