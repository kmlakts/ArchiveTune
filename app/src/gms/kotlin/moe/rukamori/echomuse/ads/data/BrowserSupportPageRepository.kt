...
package moe.rukamori.echomuse.ads.data
...
import moe.rukamori.echomuse.ads.domain.SupportPageOpenResult
import moe.rukamori.echomuse.ads.domain.SupportPageRepository
...
internal class BrowserSupportPageRepository
    ...
    constructor(
        ...
        private fun supportPageUnavailable(exception: RuntimeException): SupportPageOpenResult {
            Timber.w(exception, "Unable to open the Echomuse support page")
