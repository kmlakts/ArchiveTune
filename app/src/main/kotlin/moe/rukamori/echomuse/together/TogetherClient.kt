...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: moe.rukamori.echomuse.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: moe.rukamori.echomuse.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: moe.rukamori.echomuse.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is moe.rukamori.echomuse.together.JoinDecision -> {
                            ...
                            is moe.rukamori.echomuse.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
