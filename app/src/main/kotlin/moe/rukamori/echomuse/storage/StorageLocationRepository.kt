...
package moe.rukamori.echomuse.storage
...
import moe.rukamori.echomuse.constants.GitHubContributorsEtagKey
import moe.rukamori.echomuse.constants.GitHubContributorsJsonKey
import moe.rukamori.echomuse.constants.GitHubContributorsLastCheckedAtKey
import moe.rukamori.echomuse.constants.GitHubTranslationContributorsJsonKey
import moe.rukamori.echomuse.constants.GitHubTranslationContributorsLastCheckedAtKey
import moe.rukamori.echomuse.constants.StorageFolderDisplayNameKey
import moe.rukamori.echomuse.constants.StorageFolderIdKey
import moe.rukamori.echomuse.constants.StorageFolderPathKey
import moe.rukamori.echomuse.constants.StorageFolderTreeUriKey
...
import moe.rukamori.echomuse.utils.ArtworkStorage
...
private fun File.ensureWritableDirectory(): Boolean =
    runCatching {
        ...
        val probe = File(this, ".echomuse-storage-probe")
        probe.writeText("ok")
        probe.delete()
    }.isSuccess
...
private const val ExternalStorageRootDirectoryName = "Echomuse"
...
private const val SavedArtworkCacheFileName = "echomuse_saved_artworks.json"
