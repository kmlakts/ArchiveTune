...
package moe.rukamori.echomuse.musicrecognition
...
class BackgroundMusicRecognitionService : Service() {
    ...
    companion object {
        private const val ActionRecognizePlayback =
            "moe.rukamori.echomuse.action.RECOGNIZE_DEVICE_PLAYBACK"
        private const val ActionRecognizeMicrophone =
            "moe.rukamori.echomuse.action.RECOGNIZE_MICROPHONE"
        private const val ActionCancel =
            "moe.rukamori.echomuse.action.CANCEL_BACKGROUND_RECOGNITION"
