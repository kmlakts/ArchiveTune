...
package moe.rukamori.echomuse.backup
...
import moe.rukamori.echomuse.extensions.zipOutputStream
...
class BackupArchiveRepository
    ...
    constructor(
        ...
        private suspend fun writeSettingsToXml(
            ...
            serializer.startTag(null, "EchomuseBackup")
            ...
            serializer.endTag(null, "EchomuseBackup")
