...
import moe.rukamori.echomuse.constants.QueueEditLockKey
...
import moe.rukamori.echomuse.extensions.toggleRepeatMode
...
import moe.rukamori.echomuse.ui.component.MediaMetadataListItem
import moe.rukamori.echomuse.ui.component.TextFieldDialog
import moe.rukamori.echomuse.ui.menu.AddToPlaylistDialog
import moe.rukamori.echomuse.ui.menu.PlayerMenu
import moe.rukamori.echomuse.ui.utils.ShowMediaInfo
import moe.rukamori.echomuse.utils.oem.SystemMediaControlResolver
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is moe.rukamori.echomuse.together.TogetherSessionState.Joined &&
            (togetherSessionState as moe.rukamori.echomuse.together.TogetherSessionState.Joined).role is moe.rukamori.echomuse.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? moe.rukamori.echomuse.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is moe.rukamori.echomuse.together.TogetherRole.Guest
                                                                if (isGuest) {
