...
import moe.rukamori.echomuse.logcat.LogcatLevel
import moe.rukamori.echomuse.ui.utils.backToMain
import moe.rukamori.echomuse.viewmodels.LogcatEffect
import moe.rukamori.echomuse.viewmodels.LogcatScreenState
import moe.rukamori.echomuse.viewmodels.LogcatUiEntries
import moe.rukamori.echomuse.viewmodels.LogcatUiEntry
import moe.rukamori.echomuse.viewmodels.LogcatUiModel
import moe.rukamori.echomuse.viewmodels.LogcatViewModel
import moe.rukamori.echomuse.ui.component.IconButton as EchomuseIconButton
            ...
            when (effect) {
                ...
                is LogcatEffect.Export -> {
                    val exportIntent =
                        Intent(Intent.ACTION_SEND).apply {
                            type = "text/plain"
                            clipData = ClipData.newRawUri("echomuse-log.txt", effect.uri)
