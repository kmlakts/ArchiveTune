...
package moe.rukamori.echomuse.library
...
import moe.rukamori.echomuse.ai.AiTextService
...
import moe.rukamori.echomuse.repository.LibraryTopMixRepository
        ...
        private suspend fun requestAiMixes(
            ...
            val response =
                AiTextService.complete(
                    ...
                    systemPrompt =
                        """
                        You are a music curator for Echomuse.
