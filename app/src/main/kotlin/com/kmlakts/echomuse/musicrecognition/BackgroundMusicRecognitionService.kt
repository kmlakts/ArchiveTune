...
package com.kmlakts.echomuse.musicrecognition
...
class BackgroundMusicRecognitionService : Service() {
    ...
    companion object {
        private const val ActionRecognizePlayback =
            "com.kmlakts.echomuse.action.RECOGNIZE_DEVICE_PLAYBACK"
        private const val ActionRecognizeMicrophone =
            "com.kmlakts.echomuse.action.RECOGNIZE_MICROPHONE"
        private const val ActionCancel =
            "com.kmlakts.echomuse.action.CANCEL_BACKGROUND_RECOGNITION"
