...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.kmlakts.echomuse.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: com.kmlakts.echomuse.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.kmlakts.echomuse.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.kmlakts.echomuse.together.JoinDecision -> {
                            ...
                            is com.kmlakts.echomuse.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
