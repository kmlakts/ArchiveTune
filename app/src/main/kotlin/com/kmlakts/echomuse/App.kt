...
import com.kmlakts.echomuse.canvas.EchomuseCanvas
import com.kmlakts.echomuse.constants.*
import com.kmlakts.echomuse.extensions.*
...
import com.kmlakts.echomuse.ui.screens.settings.ThemePalettes
import com.kmlakts.echomuse.ui.theme.ThemeSeedPalette
import com.kmlakts.echomuse.ui.theme.ThemeSeedPaletteCodec
import com.kmlakts.echomuse.utils.MoriCipherUpdateScheduler
import com.kmlakts.echomuse.utils.PreferenceStore
import com.kmlakts.echomuse.utils.ProxyUtils
import com.kmlakts.echomuse.utils.YTPlayerUtils
import com.kmlakts.echomuse.utils.clearPlaybackAuthSession
import com.kmlakts.echomuse.utils.clearPlaybackWebAuthSession
import com.kmlakts.echomuse.utils.dataStore
import com.kmlakts.echomuse.utils.get
import com.kmlakts.echomuse.utils.potoken.BotGuardTokenGenerator
import com.kmlakts.echomuse.utils.reportException
import com.kmlakts.echomuse.utils.toPlaybackAuthState
import okhttp3.Dns
...
class App :
    ...
    private fun initializeCriticalSync() {
        ...
        EchomuseCanvas.initialize(BuildConfig.CANVAS_BEARER_TOKEN)
        PaxsenixLyrics.setUserAgent("Echomuse", BuildConfig.VERSION_NAME)
