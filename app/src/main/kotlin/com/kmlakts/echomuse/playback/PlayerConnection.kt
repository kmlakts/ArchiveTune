...
import com.kmlakts.echomuse.extensions.getCurrentQueueIndex
...
import com.kmlakts.echomuse.ui.player.refetchCanvasArtworkForPlayback
...
class PlayerConnection(
    ...
    fun seekToNext() {
        val state = service.togetherSessionState.value as? com.kmlakts.echomuse.together.TogetherSessionState.Joined
        if (state?.role is com.kmlakts.echomuse.together.TogetherRole.Guest) {
            service.requestTogetherControl(com.kmlakts.echomuse.together.ControlAction.SkipNext)
            return
        }
        player.seekToNext()
        player.prepare()
    ...
    fun seekToPrevious() {
        val state = service.togetherSessionState.value as? com.kmlakts.echomuse.together.TogetherSessionState.Joined
        if (state?.role is com.kmlakts.echomuse.together.TogetherRole.Guest) {
            service.requestTogetherControl(com.kmlakts.echomuse.together.ControlAction.SkipPrevious)
            return
        }
