...
import com.kmlakts.echomuse.constants.ArtistSeparatorsKey
...
import com.kmlakts.echomuse.constants.ExternalDownloaderEnabledKey
import com.kmlakts.echomuse.constants.ExternalDownloaderPackageKey
import com.kmlakts.echomuse.constants.HISTORY_DURATION_DEFAULT
import com.kmlakts.echomuse.constants.HistoryDuration
import com.kmlakts.echomuse.constants.LowDataModeKey
...
import com.kmlakts.echomuse.constants.SeekExtraSeconds
...
import com.kmlakts.echomuse.ui.component.ArtistSeparatorsDialog
import com.kmlakts.echomuse.ui.component.CrossfadeSliderPreference
...
import com.kmlakts.echomuse.ui.component.SliderPreference
import com.kmlakts.echomuse.ui.component.SwitchPreference
import com.kmlakts.echomuse.ui.component.TextFieldDialog
...
fun PlayerSettings(navController: NavController) {
    ...
    val isEchomuseExtractorEnabled = false
    val playerStreamClients =
        remember {
            listOf(
                PlayerStreamClient.WEB_REMIX,
                PlayerStreamClient.ECHOMUSE_EXTRACTOR,
            )
        }
    ...
    val audioQualityEnabled = selectedPlayerStreamClient != PlayerStreamClient.ECHOMUSE_EXTRACTOR
    val isPlayerStreamClientEnabled =
        remember(isEchomuseExtractorEnabled) {
            { client: PlayerStreamClient ->
                client != PlayerStreamClient.ECHOMUSE_EXTRACTOR ||
                    ...
                    ListPreference(
                        ...
                        valueText = {
                            when (it) {
                                ...
                                PlayerStreamClient.ECHOMUSE_EXTRACTOR -> {
                                    stringResource(
                                        R.string.player_stream_client_echomuse_extractor,
                                    )
                                }
