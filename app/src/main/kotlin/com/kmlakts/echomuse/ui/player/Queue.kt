...
import com.kmlakts.echomuse.constants.QueueEditLockKey
...
import com.kmlakts.echomuse.extensions.toggleRepeatMode
...
import com.kmlakts.echomuse.ui.component.MediaMetadataListItem
import com.kmlakts.echomuse.ui.component.TextFieldDialog
import com.kmlakts.echomuse.ui.menu.AddToPlaylistDialog
import com.kmlakts.echomuse.ui.menu.PlayerMenu
import com.kmlakts.echomuse.ui.utils.ShowMediaInfo
import com.kmlakts.echomuse.utils.oem.SystemMediaControlResolver
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.kmlakts.echomuse.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is com.kmlakts.echomuse.together.TogetherRole.Guest
                                                                if (isGuest) {
