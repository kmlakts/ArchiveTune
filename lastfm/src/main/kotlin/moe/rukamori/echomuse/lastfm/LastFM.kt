...
package moe.rukamori.echomuse.lastfm
...
import moe.rukamori.echomuse.lastfm.models.LastFmError
import moe.rukamori.echomuse.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    const val FALLBACK_COMPAT_API_KEY = "echomuse"
    const val FALLBACK_COMPAT_SECRET = "echomuse"
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "Echomuse (https://github.com/rukamori/ArchiveTune)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
